...
@section("content")
<h1>sua san pham</h1> <a href="{{url("/backend/product/index")}}">Black</a>
{{--thanh công--}}
@if(session('status'))
...
{{--        để thay thế chuỗi sau đó gán lại chính cho biến $product->product_image--}}
    ...
    <div class="form-group">
        ...
        <textarea name="product_desc" class="form-control" rows="10"
                  id="product_desc">{{ $product->product_desc }}</textarea>
